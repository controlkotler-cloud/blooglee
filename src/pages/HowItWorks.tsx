...
import { ArrowRight, Globe, Settings, Sparkles, Send, CheckCircle2, Clock, Zap } from "lucide-react";
...
const howItWorksFAQs = [
  {
    ...
    answer:
      "El proceso de generación tarda aproximadamente 60 segundos. Después puedes revisar, editar si quieres, y publicar con un clic adicional.",
  },
  {
    question: "¿Necesito conocimientos técnicos?",
    answer:
      "No. Si sabes publicar en WordPress, sabes usar Blooglee. El proceso es muy intuitivo y no requiere configuraciones técnicas complejas.",
  },
  {
    question: "¿Cómo conecto mi WordPress?",
    answer:
      "Necesitas crear un Application Password en tu WordPress (Usuarios → Tu perfil → Application Passwords). Copias la URL, usuario y contraseña de aplicación en Blooglee y listo.",
  },
  {
    question: "¿Puedo revisar el artículo antes de publicar?",
    answer:
      "Sí, siempre. Blooglee te muestra una vista previa completa del artículo con título, contenido e imagen. Puedes editarlo o regenerarlo antes de publicar.",
  },
  {
    question: "¿Qué pasa si no me gusta el artículo generado?",
    answer:
      "Puedes regenerar el artículo con un clic para obtener una versión diferente. También puedes editar el texto directamente antes de publicar.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Crea un Application Password en tu WordPress (Usuarios → Perfil → Application Passwords). Copia la URL, usuario y contraseña en Blooglee.",
    time: "2 min (una vez)",
  ...
  },
  {
    ...
    description:
      "Elige tu sector (salud, retail, tech...), idioma (español, catalán, inglés) y frecuencia de publicación (semanal, quincenal, mensual).",
    time: "1 min (una vez)",
  ...
  },
  {
    ...
    description:
      "Modo manual: revisa la vista previa y publica con un clic. Modo automático: Blooglee genera y publica por ti sin que tengas que hacer nada.",
    time: "Opcional",
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-xl p-8 sm:p-10">
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div className="flex items-center gap-4">
                    <span
                      className={`text-6xl font-display font-bold bg-gradient-to-br ${step.color} bg-clip-text text-transparent`}
                    >
                      {step.number}
                    </span>
                    <div
      ...
      <section className="container mx-auto max-w-7xl px-4 sm:px-6 py-12 pb-20">
        <div className="relative overflow-hidden rounded-3xl p-8 sm:p-12 text-center">
          ...
          <div className="relative z-10">
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-white mb-4">¿Listo para empezar?</h2>
            <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
              Únete a la lista de espera y te avisamos en cuanto abramos nuevas plazas.
            </p>
