        ...
        <div className="max-w-7xl mx-auto">
          <div className="glass-card-strong rounded-2xl px-4 sm:px-6 py-3 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link to="/#features" className="text-sm font-medium text-foreground/70 hover:text-foreground transition-colors link-underline">
                Características
              </Link>
              <Link to="/pricing" className="text-sm font-medium text-foreground transition-colors link-underline">
                Precios
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link
                to="/auth"
                className="btn-aurora text-sm py-2 px-5"
              >
          ...
          {/* Mobile Menu */}
          {mobileMenuOpen && (
            <div className="md:hidden mt-2 glass-card-strong rounded-2xl p-4 animate-fade-in">
              <div className="flex flex-col gap-3">
                ...
                <Link
                  to="/auth"
                  className="btn-aurora text-sm py-3 text-center"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <span>Empezar gratis</span>
                </Link>
      ...
      <footer className="border-t border-border/50 py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-foreground/50">
            © 2025 Blooglee. Todos los derechos reservados.
          </p>
        </div>
      </footer>
    </div>
