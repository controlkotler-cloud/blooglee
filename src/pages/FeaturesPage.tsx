...
const featuresFAQs = [
  ...
  },
  {
    ...
    answer:
      "Sí, todas las imágenes destacadas incluidas en los artículos de Blooglee provienen de bancos de imágenes libres de derechos (Pexels, Unsplash) o son generadas por IA. Los créditos del fotógrafo se incluyen automáticamente cuando corresponde.",
  },
  {
    question: "¿Puedo programar publicaciones automáticas en Blooglee?",
    answer:
      "Sí, Blooglee permite configurar la frecuencia de publicación (semanal, quincenal, mensual) y genera automáticamente los artículos según el calendario. También puedes publicar manualmente cuando prefieras revisar antes de publicar.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sí, Blooglee genera meta títulos y meta descripciones optimizados que Yoast SEO reconoce automáticamente. También es compatible con Rank Math y otros plugins de SEO.",
  },
  {
    question: "¿Funciona con Polylang para multiidioma?",
    answer:
      "Sí, Blooglee es compatible con Polylang y WPML. Puedes generar artículos en español, catalán o inglés y asignarlos al idioma correspondiente en tu WordPress multiidioma.",
  },
  {
    question: "¿Cómo funciona la integración con WordPress?",
    answer:
      "Blooglee se conecta a WordPress mediante Application Passwords (disponibles desde WP 5.6). Configuras la conexión una vez y después publicas con un clic. No requiere instalar ningún plugin.",
  },
  {
    question: "¿El contenido pasa los detectores de IA?",
    answer:
      "El contenido generado por Blooglee es único y de alta calidad. Aunque es generado por IA, está optimizado para ser natural y legible. Puedes editarlo antes de publicar para añadir tu toque personal.",
  },
];
const features = [
  {
    ...
    description:
      "Nuestra IA avanzada crea artículos únicos y de calidad profesional adaptados a tu sector y audiencia.",
      ...
      <section className="container mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-24">
          {features.map((feature, i) => (
            <div
              key={i}
              className="group relative p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white/70 backdrop-blur-xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-500"
            >
              <div
                className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}
              >
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-white/50 shadow-xl p-6 sm:p-8 lg:p-12 mb-16 sm:mb-24">
          <div className="text-center mb-10">
            <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4">
              Blooglee vs <span className="text-foreground/40">hacerlo manualmente</span>
            </h2>
            <p className="text-foreground/60">Compara el tiempo y recursos que ahorras con Blooglee</p>
          </div>
        ...
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
              Únete hoy a la lista de espera y descubre cómo Blooglee puede transformar tu estrategia de contenido.
            </p>
