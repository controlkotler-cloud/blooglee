...
const features = [
  {
    ...
    benefits: [
      'Contenido original y único cada vez',
      'Adaptado al tono de tu marca',
  ...
  },
  {
    ...
    benefits: [
      'Español y catalán incluidos',
      'Más idiomas próximamente',
      'Traducción de calidad nativa',
    ],
...
const comparison = [
  ...
  { feature: 'Consistencia', manual: 'Variable', blooglee: 'Garantizada' },
  { feature: 'Coste mensual', manual: '500€+ (redactor)', blooglee: 'Desde 0€' },
];
      ...
      <section className="container mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16 sm:mb-24">
          ...
          <div className="text-center p-6 sm:p-8 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/50 shadow-xl">
            ...
            <p className="text-foreground/60">empresas confían en nosotros</p>
          </div>
        </div>
