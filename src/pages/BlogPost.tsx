...
const BlogPost = () => {
  ...
  // Fetch related posts
  const { data: relatedPosts = [] } = useRelatedPosts(slug || "", post?.category || "SEO", 3);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-3">
            ...
            <header className="mb-8">
              ...
              <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">{post.title}</h1>
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden mb-8 shadow-xl">
              <img
                src={post.image}
                srcSet={buildBlogSrcSet(post.image)}
          ...
          <aside className="hidden lg:block lg:col-span-1">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-gradient-to-br from-violet-500 via-fuchsia-500 to-orange-400 rounded-2xl p-6 text-white">
                ...
                <p className="text-white/80 text-sm mb-4">Más consejos de marketing y contenido cada día.</p>
                <Button
                  asChild
                  variant="secondary"
                  size="sm"
                ...
                >
                  <a href="https://www.instagram.com/blooglee_" target="_blank" rel="noopener noreferrer">
                    @blooglee_
                  </a>
                </Button>
              </div>
