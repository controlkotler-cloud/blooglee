    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Gestión de Farmacias y Empresas</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <ArticlePreview 
        ...
        onRegenerate={previewArticle ? () => {
         ...
         isRegenerating={previewArticle ? isGenerating(previewArticle.pharmacy.id) : false}
      ...
      <CompanyArticlePreview 
        ...
        onRegenerate={previewCompanyArticle ? () => {
         ...
         isRegenerating={previewCompanyArticle ? isGenerating(previewCompanyArticle.company.id) : false}
